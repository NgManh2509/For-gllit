...
export const TextHighlighter = forwardRef(({
  ...
  const shouldAnimate = triggerType === 'hover' ? isHovered : triggerType === 'inView' ? isInView : triggerType === 'ref' ? isAnimating : triggerType === 'auto' ? true : false;
  ...
  const defaultGradient = 'bg-gradient-to-r from-orange-400 to-orange-200 dark:from-orange-500 dark:to-orange-300';
